...
Los recursos se encuentran en `assets/brand/`. Se generaron específicamente para este proyecto mediante el generador de imágenes integrado; el conjunto de instrucciones visuales cubrió una portada de supermercado regional sin texto, seis bodegones fotográficos por categoría y un logotipo transparente.
...
La comprobación final confirmó 60 productos publicados con imagen, un único transportista web publicado, proveedor Demo en modo de prueba, idioma `es_419`, 24 productos por página y el pedido `S00171` vinculado a la factura publicada `INV/2026/00151`. La confirmación del pedido permaneció visible y funcional por HTTPS después de reiniciar Odoo.
